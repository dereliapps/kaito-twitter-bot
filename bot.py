...
# API Anahtarları - Environment variables'dan al (güvenli)
api_key = os.getenv('TWITTER_API_KEY', 'XKD2cz0D8uWJoK8B3hsdsVced')
api_secret = os.getenv('TWITTER_API_SECRET', '0pDdMGxPzzzNeLx0nNmA0fWRuFi6iN8h4KJUHyMUmRgdhp8fEQ')
access_token = os.getenv('TWITTER_ACCESS_TOKEN', '1717930505398587392-w1p5TUJvXjmj2Fdsr5koPon3qGBgfR')
access_secret = os.getenv('TWITTER_ACCESS_SECRET', 'qcGd5Z2N8DM55rJIwQnd052N2ekZYfARwWqIZQEi7onbF')
bearer_token = os.getenv('TWITTER_BEARER_TOKEN', 'AAAAAAAAAAAAAAAAAAAAAKuWLgEAAAAA%2BoLLwSJrDDfTD8HZH6eZrTkPOTQ%3DHOwwX8o8MInE8eWGnqwPqSr1SbfNLKh3ktLMQzKV8BXDKL2y5E')
openai_key = os.getenv('OPENAI_API_KEY', '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')
